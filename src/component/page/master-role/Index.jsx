...
const dataFilterSort = [
  { Value: "[Role Name] asc", Text: "Role Name [↑]" },
  { Value: "[Role Name] desc", Text: "Role Name [↓]" },
...
export default function MasterRoleIndex({ onChangePage }) {
  ...
  function handleSetStatus(id) {
    setIsLoading(true);
    setIsError(false);
    UseFetch(API_LINK + "MasterRole/SetStatusRole", {
      idRole: id.trim(),
    })
      .then((data) => {
    ...
    const fetchData = async () => {
      ...
      try {
        const data = await UseFetch(
          API_LINK + "MasterRole/GetDataRole",
          currentFilter
        );
